...
/**
 * this class sprint comment data
 */
@Getter
@Setter
...
public class SprintDto extends BaseDto {
    ...
    public SprintDto(final UUID id, final @NotNull String name, final String goal, final @NotNull LocalDateTime fromDate,
                     final @NotNull LocalDateTime toDate, final LocalDateTime startDate, final LocalDateTime closeDate,
                     final Short daysCycle, final Boolean hasStarted, final Boolean isClosed, final Short originalPoints,
                     final Short finalPoints, final LocalDateTime createdAt,
